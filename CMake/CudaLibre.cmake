...
macro(cuda_add_executable name)
    ...
    foreach(arg ${ARGN})
        ...
        if(${_CU_POS} STREQUAL -1)
            ...
            if(${_CU_POS} STREQUAL 3)
                add_custom_target(${arg}_clcc ALL COMMAND ${CLCC} ${CMAKE_CURRENT_SOURCE_DIR}/${arg} ${CMAKE_CURRENT_BINARY_DIR}/${arg}.cpp)
                execute_process(COMMAND ${CLCC} ${CMAKE_CURRENT_SOURCE_DIR}/${arg} ${CMAKE_CURRENT_BINARY_DIR}/${arg}.cpp)
    ...
    target_link_libraries(${name} lcruntime ${OpenCL_LIBRARIES})
endmacro()
